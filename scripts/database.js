...
/* 
    the database contains the information we will need to input 
    into our functions. these functions are copied at the bottom.
    this database includes a list of walkers, walker's cities, cities, 
...
// these functions are created to export to our other js files
